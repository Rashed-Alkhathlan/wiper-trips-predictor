...
def setup_agent(_df):
    ...
    try:
        from agent.agent_tools import create_data_tools
...
def render_advisor_chat(df):
    ...
    with qa1:
        ...
        if st.button("Run", key="qa_risk", width="stretch"):
    ...
    with qa2:
        ...
        if st.button("Run", key="qa_torque", width="stretch"):
    ...
    with qa3:
        ...
        if st.button("Run", key="qa_hist", width="stretch"):
    ...
    with qa4:
        ...
        if st.button("Run", key="qa_corr", width="stretch"):
